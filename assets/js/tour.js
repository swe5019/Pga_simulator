...
const TOUR_STEPS = [
  ...
  },
  {
    ...
    body: 'Salary comes straight from the DK slate. Edit Skill, Proj, or Own% inline, set per-golfer Min/Max exposure, lock 🔒 a must-play, or ban 🚫 someone out of the player pool.',
  },
  {
